...
public class DropDownCache {
	 ...
	 static ImmutableMap<String, String> roleMap= null;
	 ...
	 public void  initializeMenuRoles(   List<RolesMenuDto> menuRolesList ) {
		 Map<String, String> menuRolesMap = new HashMap< String,String>();
		
		 menuRolesList.forEach(menuRole->{
			 menuRolesMap.put(menuRole.getMenu(), menuRole.getRole());
		 });
		 roleMap = ImmutableMap.copyOf( menuRolesMap );
		  System.out.println(" DropDownCache map size ===== "+map.size());
	 }
