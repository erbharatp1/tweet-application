...
public enum EmployeeLifeCycleChartEnum {
	...
	numVisiblePlot("6"), scrollheight("5"), flatScrollBars("1"), scrollShowButtons("0");
	public String pieChartValue;

	EmployeeLifeCycleChartEnum(String pieChartValue) {
