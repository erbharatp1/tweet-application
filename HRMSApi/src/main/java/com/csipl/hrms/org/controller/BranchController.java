...
public class BranchController   {
	...
	public @ResponseBody List<BranchDTO> findAllBranches(@PathVariable("companyId") Long companyId,HttpServletRequest req) throws ErrorHandling, PayRollProcessException {
