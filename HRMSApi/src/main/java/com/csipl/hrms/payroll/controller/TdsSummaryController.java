...
public class TdsSummaryController {
	...
	public @ResponseBody TdsSummaryChangeDTO getTdsSummary(@RequestParam("employeeId") String employeeId,
		...
		if(financialYear.getFinancialYearId()!=null)
		 tdsSummaryChange =tdsSummaryService.getTdsSummary(empId, financialYear.getFinancialYearId());
		
		TdsSummaryChangeDTO tdsSummaryChangeDTO = new TdsSummaryChangeDTO();
		
		if(tdsSummaryChange!=null) {
			  tdsSummaryChangeDTO=	 tdsSummaryChangeAdaptor.databaseModelToUiDto(tdsSummaryChange);
