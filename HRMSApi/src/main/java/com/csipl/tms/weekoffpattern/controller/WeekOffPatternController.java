...
public class WeekOffPatternController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully retrieved list"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you were trying to reach is forbidden"),
			@ApiResponse(code = 404, message = "The resource you were trying to reach is not found") })
	@ApiOperation(value = "View active weekoffpattern based on companyId ")
	@RequestMapping(value = "/companyweekoffpattern/{companyId}", method = RequestMethod.GET)
	public @ResponseBody WeekOffPatternDTO getAllWeekOffPatternDTO(@PathVariable("companyId") Long companyId)
			throws ErrorHandling {
		...
		List<WeekOffPatternDTO> weekOffPatternDtoList = week_Off_PatternAdaptor
				.databaseModelToUiDtoList(week_Off_PatternList);
	...
	public @ResponseBody List<WeekOffPatternDTO> getAllWeekOffPattern(@PathVariable("companyId") Long companyId)
			throws ErrorHandling {
		logger.info("getAllWeekOffPattern is calling : ");
		WeekOffPatternDTO WeekOffPatternDto = new WeekOffPatternDTO();
		List<WeekOffPattern> week_Off_PatternList = week_Off_PatternService.getAllWeekOffPattern(companyId);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully retrieved list"),
			...
			@ApiResponse(code = 403, message = "Accessing the resource you were trying to reach is forbidden"),
			@ApiResponse(code = 404, message = "The resource you were trying to reach is not found") })
	@ApiOperation(value = "View all weekoffpattern based on companyId ")
	@RequestMapping(value = "/weekOff/{companyId}", method = RequestMethod.GET)
	public @ResponseBody List<WeekOffPatternDTO> getWeekOffPatternBycompnyId(@PathVariable("companyId") Long companyId)
			throws ErrorHandling {
		logger.info("getAllWeekOffPattern is calling : ");
		List<WeekOffPattern> week_Off_PatternList = week_Off_PatternService.getWeekOffPattern(companyId);
		logger.info("getAllWeekOffPattern is end  :" + week_Off_PatternList);
