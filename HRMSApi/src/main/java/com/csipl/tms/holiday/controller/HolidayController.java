...
public class HolidayController {
	...
	@ApiOperation(value = "View List of holiday based on company ID")
	@RequestMapping(value = "findAllHolidayView/{leavePeriodId}", method = RequestMethod.GET)
	public List<HolidayDTO> findAllHolidayView(@PathVariable("leavePeriodId") Long leavePeriodId, HttpServletRequest req) {
		logger.info("leavePeroidList is calling : " + " : leavePeriodId " + leavePeriodId);
	//	Long companyID = Long.parseLong(leavePeriodId);
		List<TMSHolidays> holidayList = holidayService.findAllHolidayView(leavePeriodId);
