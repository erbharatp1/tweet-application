...
public class LeaveTypeServiceImpl implements LeaveTypeService {
	 ...
	 */
	@Override
	public List<TMSLeaveType> findAllLeavePeriod(Long leavePeriodId,Long leaveSchemeId) {
		log.info("LeaveTypeServiceImpl.findAllLeavePeriod()");
		return leaveTypeRepository.findAllPeriod(leavePeriodId,leaveSchemeId);
	}



	@Override
	public List<Object[]> findOpeningLeaveType(Long employeeId, Long companyId,String periodId) {
		// TODO Auto-generated method stub
		return leaveTypeRepository.findAllpreviousOpeningLeaveType(employeeId,companyId,periodId);
	}
