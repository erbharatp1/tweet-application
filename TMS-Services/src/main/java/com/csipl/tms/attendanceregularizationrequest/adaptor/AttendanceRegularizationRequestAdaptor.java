...
public class AttendanceRegularizationRequestAdaptor
	...
	public List<AttendanceRegularizationRequestDTO> objarListToObjUiDtoList(List<Object[]> arRequestObjList) {
		...
		for (Object[] arRequestObj : arRequestObjList) {
			...
			String employeeLogoPath = arRequestObj[16] != null ? (String) arRequestObj[16] : null;
			String approvalRemark = arRequestObj[17] != null ? (String) arRequestObj[17] : null;
			...
			arRequestDto.setApprovalRemark(approvalRemark);
			arRequestDto.setEmployeeLogoPath(employeeLogoPath);
	...
	public List<AttendanceRegularizationRequestDTO> databaseModelARRequestDetailsDtoListWithPagination(
			List<Object[]> aRRequestList) {
		List<AttendanceRegularizationRequestDTO> arRequestDtoList = new ArrayList<AttendanceRegularizationRequestDTO>();

		for (Object[] arRequest : aRRequestList) {
			AttendanceRegularizationRequestDTO arRequestDto = new AttendanceRegularizationRequestDTO();
			
			Long arID = arRequest[0] != null ? Long.parseLong(arRequest[0].toString()) : null;
			Long employeeId = arRequest[1] != null ? Long.parseLong(arRequest[1].toString()) : null;
			Long approvalId = arRequest[2] != null ? Long.parseLong(arRequest[2].toString()) : null;
			Long compnayId = arRequest[3] != null ? Long.parseLong(arRequest[3].toString()) : null;
			String approvalRemark = arRequest[4] != null ? (String) arRequest[4] : null;
			String employeeRemark = arRequest[5] != null ? (String) arRequest[5] : null;
			String cancelRemark = arRequest[6] != null ? (String) arRequest[6] : null;
			Date dateCreated = arRequest[7] != null ? (Date) (arRequest[7]) : null;
			String arCategory = arRequest[8] != null ? (String) arRequest[8] : null;
			Date actionableDate = arRequest[9] != null ? (Date) (arRequest[9]) : null;
			Date fromDate = arRequest[10] != null ? (Date) (arRequest[10]) : null;
			Date toDate = arRequest[11] != null ? (Date) (arRequest[11]) : null;
			Long day = arRequest[12] != null ? Long.parseLong(arRequest[12].toString()) : null;
			String status = arRequest[13] != null ? (String) arRequest[13] : null;
			...
			arRequestDto.setApprovalRemark(approvalRemark);
			arRequestDto.setEmployeeRemark(employeeRemark);
			arRequestDto.setCancelRemark(cancelRemark);
			arRequestDto.setDateCreated(dateCreated);
			arRequestDto.setArCategory(arCategory);
			
			if (arRequestDto.getArCategory().equals("MP")) {
				arRequestDto.setArCategory("MP");
				arRequestDto.setArCategoryValue(DropDownCache.getInstance().getDropDownValue(
						DropDownEnum.ARCategory.getDropDownName(), arRequestDto.getArCategory()));
			}
			if (arRequestDto.getArCategory().equals("MN")) {
				arRequestDto.setArCategory("MN");
				arRequestDto.setArCategoryValue(DropDownCache.getInstance().getDropDownValue(
						DropDownEnum.ARCategory.getDropDownName(), arRequestDto.getArCategory()));
			}
			if (arRequestDto.getArCategory().equals("CN")) {
				arRequestDto.setArCategory("CN");
				arRequestDto.setArCategoryValue(DropDownCache.getInstance().getDropDownValue(
						DropDownEnum.ARCategory.getDropDownName(), arRequestDto.getArCategory()));
			}
			if (arRequestDto.getArCategory().equals("PC")) {
				arRequestDto.setArCategory("PC");
				arRequestDto.setArCategoryValue(DropDownCache.getInstance().getDropDownValue(
						DropDownEnum.ARCategory.getDropDownName(), arRequestDto.getArCategory()));
			}
			...
			if (arRequestDto.getStatus().equals(StatusMessage.PENDING_CODE)) {
				arRequestDto.setStatus(StatusMessage.PENDING_CODE);
				arRequestDto.setStatusValue(StatusMessage.PENDING_VALUE);
			}
			if (arRequestDto.getStatus().equals(StatusMessage.APPROVED_CODE)) {
				arRequestDto.setStatus(StatusMessage.APPROVED_CODE);
				arRequestDto.setStatusValue(StatusMessage.APPROVED_VALUE);
			}
			if (arRequestDto.getStatus().equals(StatusMessage.REJECTED_CODE)) {
				arRequestDto.setStatus(StatusMessage.REJECTED_CODE);
				arRequestDto.setStatusValue(StatusMessage.REJECTED_VALUE);
			}
			if (arRequestDto.getStatus().equals(StatusMessage.CANCEL_CODE)) {
				arRequestDto.setStatus(StatusMessage.CANCEL_CODE);
				arRequestDto.setStatusValue(StatusMessage.CANCEL_VALUE);
			}
