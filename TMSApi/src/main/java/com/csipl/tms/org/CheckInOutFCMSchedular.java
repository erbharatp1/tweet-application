...
//			
//			//fcm.fcmRequestforCheckIO(  "Attendance Check Out","Please Do Attendance Out Otherwise You Will Be Mark As Absent", "attendanceio",0l, "attendanceio");
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		
...
//		      System.out.println("Java attendanceio expression:: " + strDate);
//		      
//			//fcm.fcmRequestforCheckIO(  "Attendance Check In","Please Mark Attendance In", "attendanceio",0l, "attendanceio");
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}
