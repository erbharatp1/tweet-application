...
public class TdsStandardExemptionServiceImpl implements TdsStandardExemptionService {
	...
	@Override
	public TdsStandardExemption getTdsStandardExemption(Long companyId, FinancialYear financialYear ) {
//		DateUtils dateUtils=new DateUtils();
//		Date currentDate=dateUtils.getCurrentDate();
//		FinancialYear financialYear=financialYearRepository.getFinancialYear(currentDate, companyId);
		return tdsStandardExemptionRepository.findTdsStandardExemption(companyId,financialYear.getFinancialYearId());
	}
}
