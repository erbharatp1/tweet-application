...
public class StorageService {
	...
	public String createFilePath(String createPath) {
		String tenantId = geTenantId("");
		String filePath = File.separator+"tenantsFile"+File.separator + tenantId + createPath;
		return filePath;
	}
	
	public String geTenantId(String s) {
...
//				rootPath= rootPath+File.separator+tenantId+File.separator+filePath;
