...
public class PreviousEmployerIncomeAdaptor {
	...
	public List<PreviousEmployerIncomeTds> uiDtoToDatabaseModelList(
			List<PreviousEmployerIncomeTdsDTO> previousEmployerIncomeTdsDtoList, Long employeeId, Long financialYearId) {
		...
		for (PreviousEmployerIncomeTdsDTO previousEmployerIncomeTdsDto : previousEmployerIncomeTdsDtoList) {
			previousEmployerIncomeTdsList.add(uiDtoToDatabaseModel(previousEmployerIncomeTdsDto, employeeId, financialYearId));
		}
	...
	public PreviousEmployerIncomeTds uiDtoToDatabaseModel(PreviousEmployerIncomeTdsDTO previousEmployerIncomeTdsDto,
			Long employeeId, Long financialYearId) {
		...
		previousEmployerIncomeTds.setFinancialYearId(financialYearId);
		employee.setEmployeeId(employeeId);
		previousEmployerIncomeTds.setTdsTransactionUpdateStatus("AC");
	...
	public List<PreviousEmployerIncomeTdsDTO> databaseModelToObjectArray(
		...
		for (Object[] tdsPreviousEmployerIncomeObj : objectPreviousEmployerincomeList) {
			...
			BigDecimal amount = tdsPreviousEmployerIncomeObj[3] != null
					...
					: null;
			Long financialYearId = tdsPreviousEmployerIncomeObj[4] != null ? Long.parseLong(tdsPreviousEmployerIncomeObj[4].toString())
					: null;
			...
			previousEmployerIncomeTdsDto.setFinancialYearId(financialYearId);
	...
	public List<PreviousEmployerIncomeFileDTO> databaseModelToUiDtoList(List<PreviousEmployerIncomeFile> previousEmployerIncomeFileList) {
		List<PreviousEmployerIncomeFileDTO> previousEmployerIncomeFileDTOList=new ArrayList<>();
		for(PreviousEmployerIncomeFile previousEmployerIncomeFile:previousEmployerIncomeFileList) {
			previousEmployerIncomeFileDTOList.add(databaseModelToUiDto(previousEmployerIncomeFile));
		}
		return previousEmployerIncomeFileDTOList;
	}
	
 
	public PreviousEmployerIncomeFileDTO databaseModelToUiDto(PreviousEmployerIncomeFile previousEmployerIncomeFile) {
		// TODO Auto-generated method stub
		PreviousEmployerIncomeFileDTO previousEmployerIncomeFileDTO=new PreviousEmployerIncomeFileDTO();
		previousEmployerIncomeFileDTO.setPreviousEmployerIncomeFileId(previousEmployerIncomeFile.getPreviousEmployerIncomeFileId());
		previousEmployerIncomeFileDTO.setFileName(previousEmployerIncomeFile.getFileName());
		previousEmployerIncomeFileDTO.setOriginalFilename(previousEmployerIncomeFile.getOriginalFilename());
		previousEmployerIncomeFileDTO.setFilePath(previousEmployerIncomeFile.getFilePath());
		previousEmployerIncomeFileDTO.setFinancialYearId(previousEmployerIncomeFile.getFinancialYearId());
		previousEmployerIncomeFileDTO.setEmployeeId(previousEmployerIncomeFile.getEmployeeId());
		previousEmployerIncomeFileDTO.setActiveStatus(previousEmployerIncomeFile.getActiveStatus());	
		previousEmployerIncomeFileDTO.setUserId(previousEmployerIncomeFile.getUserId());
		previousEmployerIncomeFileDTO.setDateCreated(previousEmployerIncomeFile.getDateCreated());
		previousEmployerIncomeFileDTO.setDateUpdate(previousEmployerIncomeFile.getDateUpdated());
		
		return previousEmployerIncomeFileDTO;
