...
public class CorpBankAdaptor implements Adaptor<CorpBankDTO, Bank> {
	...
	public Bank uiDtoToDatabaseModel(CorpBankDTO corpBankDto) {
		...
		/*
		 * Groupg group=new Groupg(); group.setGroupId(1L);
		 */
	...
	public CorpBankDTO databaseModelToUiDto(Bank bank) {
		...
		corpBankDto.setBankNameValue(DropDownCache.getInstance()
				.getDropDownValue(DropDownEnum.BankName.getDropDownName(), bank.getBankName()));
		return corpBankDto;
	}
