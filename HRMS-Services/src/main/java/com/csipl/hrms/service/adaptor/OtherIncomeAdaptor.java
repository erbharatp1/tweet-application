...
public class OtherIncomeAdaptor implements Adaptor<OtherIncomeDTO, OtherIncome> {
	...
	public OtherIncomeDTO databaseModelToUiDto(OtherIncome otherIncome) {
		...
		otherIncomeDto.setDocumentName(otherIncome.getDocumentName());
		otherIncomeDto.setOtherIncomeDoc(otherIncome.getOtherIncomeDoc());
	...
	public OtherIncome uiDtoToOtherIncomeModel(OtherIncomeDTO otherIncomeDto, Long employeeId) {
		...
		otherIncome.setActiveStatus(StatusMessage.ACTIVE_CODE);
		otherIncome.setUserIdUpdate(otherIncomeDto.getUserIdUpdate());
		otherIncome.setDateUpdate(new Date());
		otherIncome.setDocumentName(otherIncomeDto.getDocumentName());
		otherIncome.setOtherIncomeDoc(otherIncomeDto.getOtherIncomeDoc());
		...
		otherIncome.setTdsTransactionUpdateStatus(StatusMessage.ACTIVE_CODE);
		return otherIncome;
	}
