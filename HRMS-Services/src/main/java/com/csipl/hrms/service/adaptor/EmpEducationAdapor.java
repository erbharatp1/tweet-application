...
//		 if(employeeEducation.getQualificationId().equals("GR")) {
//			 candidateEducationDTO.setDegreeName(DropDownCache.getInstance().getDropDownValue(DropDownEnum.Graduate.getDropDownName() , employeeEducation.getDegreeName()));
//		 }
//		 else if(employeeEducation.getQualificationId().equals("PO"))
//		 {
//			 candidateEducationDTO.setDegreeName(DropDownCache.getInstance().getDropDownValue(DropDownEnum.PostGraduate.getDropDownName() , employeeEducation.getDegreeName()));
//		 }
//		 else
//		 {
