...
//						String path = File.separator + "Document" + File.separator + "Employee" + File.separator + "EmployeeProfessionalDoc";
						String path = storageService.createFilePath(HrmsGlobalConstantUtil.EMPLOYEE_PROFESSIONAL_DOC);
