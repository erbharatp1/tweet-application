...
public interface LoginRepository extends CrudRepository<User, Long> {
	...
	@Modifying
	@Query("Update User u SET u.userAttempts=:userAttempts WHERE u.userId=:userId")
	public void updateById(@Param("userId") Long userId, @Param("userAttempts") Long userAttempts);
