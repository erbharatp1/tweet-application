...
public class CandidateAdaptor implements Adaptor<CandidateDTO, Candidate> {
	...
	public Candidate uiDtoToDatabaseModel(CandidateDTO candidateDto) {
		...
		candidate.setLeaveSchemeId(candidateDto.getLeaveSchemeId());
		candidate.setAttendanceSchemeId(candidateDto.getAttendanceSchemeId());
		...
		//candidate.setAdharNumber(candidateDto.getAdharNumber());
		
		
		if(candidateDto.getAdharNumber()!=null) {
			candidate.setAdharNumber(candidateDto.getAdharNumber());
		}
	
		if(candidateDto.getBranchId()!=null) {
			candidate.setBranchId(candidateDto.getBranchId());
		}
		
		if(candidateDto.getDateOfJoining()!=null)
		...
		if(candidateDto.getCandidateId() != null){
			...
			candidate.setDateCreated(candidateDto.getDateCreated());
 	...
 	public Candidate uiDtoToCandidateModel(CandidateDTO candidateDto, Candidate newJoinee) {
		...
		if (candidateDto.getCandidateId() != null && candidateDto.getFirstName() != null) {
			...
			if (candidateDto.getCandidateId() != null && candidateDto.getFirstName() != null) {
				...
				candidate.setStateId(newJoinee.getStateId());
				candidate.setShiftId(newJoinee.getShiftId());
				candidate.setAdharNumber(newJoinee.getAdharNumber());
	...
	public CandidateDTO databaseModelToUiDto(Candidate candidate) {
		...
		candidateDto.setLeaveSchemeId(candidate.getLeaveSchemeId());
		candidateDto.setAttendanceSchemeId(candidate.getAttendanceSchemeId());
		...
		System.out.println("candidate.getDateOfJoining()..."+candidate.getDateOfJoining());
		...
		candidateDto.setBranchId(candidate.getBranchId());
