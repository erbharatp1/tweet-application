...
public interface OneTimeDeductionRepository extends CrudRepository<OneTimeDeduction, Long> {
	...
	String findAllOneTimeDeduction = "SELECT emp.firstname,emp.lastname,otd.DeductionMonth,otd.Id,otd.deductionAmount,emp.employeeId,dept.departmentName, desig.designationName,emp.employeeCode,otd.remarks,otd.userId,otd.dateCreated\r\n" + 
