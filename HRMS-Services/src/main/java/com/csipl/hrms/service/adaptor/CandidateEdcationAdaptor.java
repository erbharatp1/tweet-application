...
//		 if(candidateEducation.getQualificationId().equals("GR")) {
//			 candidateEducationDTO.setDegreeName(DropDownCache.getInstance().getDropDownValue(DropDownEnum.Graduate.getDropDownName() , candidateEducation.getDegreeName()));
//		 }
//		 else if(candidateEducation.getQualificationId().equals("PO"))
//		 {
//			 candidateEducationDTO.setDegreeName(DropDownCache.getInstance().getDropDownValue(DropDownEnum.PostGraduate.getDropDownName() , candidateEducation.getDegreeName()));
//		 }
//		 else
//		 {
//			 candidateEducationDTO.setDegreeName(candidateEducation.getDegreeName());
