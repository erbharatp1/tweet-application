...
public interface CandidateIdAddressRepository extends CrudRepository<CandidateIdProof, Long>{
	...
	@Query(" from CandidateIdProof where candidateId=?1 AND idTypeId='AC'  ORDER BY  candidateIdProofsId  DESC")
    public CandidateIdProof findCandidateIdProof(Long candidateId);
