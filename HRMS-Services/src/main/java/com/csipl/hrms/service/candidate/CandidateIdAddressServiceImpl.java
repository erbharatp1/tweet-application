...
//						String path = File.separator + "Document" + File.separator + "Candidate"+ File.separator + "CandidateIdproofDoc";
						String path = storageService.createFilePath(HrmsGlobalConstantUtil.CANDIDATE_ID_PROOF_DOC);
...
//					count++;
	...
	@Override
	public CandidateIdProof getCandidateIdproof(Long candidateId) {
		// TODO Auto-generated method stub
		return candidateIdAddressRepository.findCandidateIdProof(candidateId);
	}
