...
public class TdsSummaryChangeDTO {
	...
	private BigDecimal monthlyGrossFy;

	private boolean tdsFullYearFlag; 

	private BigDecimal actualTaxableIncome;
	
	private BigDecimal actualGrossFy;
	
	private BigDecimal totalGrossPaid;
	private BigDecimal totalGrossToBePaid;
	private BigDecimal totalOneTimeEarningPaid;
	private String declarProcessMonth;
	private BigDecimal totalTaxPaid;
	private BigDecimal totalTaxToBePaid;
	...
	public BigDecimal getActualTaxableIncome() {
		return actualTaxableIncome;
	}
	public void setActualTaxableIncome(BigDecimal actualTaxableIncome) {
		this.actualTaxableIncome = actualTaxableIncome;
	}
	public BigDecimal getActualGrossFy() {
		return actualGrossFy;
	}
	public void setActualGrossFy(BigDecimal actualGrossFy) {
		this.actualGrossFy = actualGrossFy;
	}
...
//	}
	...
	public BigDecimal getMonthlyGrossFy() {
		return monthlyGrossFy;
	}
	public void setMonthlyGrossFy(BigDecimal monthlyGrossFy) {
		this.monthlyGrossFy = monthlyGrossFy;
	}
	public BigDecimal getTotalGrossPaid() {
		return totalGrossPaid;
	}
	public void setTotalGrossPaid(BigDecimal totalGrossPaid) {
		this.totalGrossPaid = totalGrossPaid;
	}
	public BigDecimal getTotalGrossToBePaid() {
		return totalGrossToBePaid;
	}
	public void setTotalGrossToBePaid(BigDecimal totalGrossToBePaid) {
		this.totalGrossToBePaid = totalGrossToBePaid;
	}
	public BigDecimal getTotalOneTimeEarningPaid() {
		return totalOneTimeEarningPaid;
	}
	public void setTotalOneTimeEarningPaid(BigDecimal totalOneTimeEarningPaid) {
		this.totalOneTimeEarningPaid = totalOneTimeEarningPaid;
	}
	public String getDeclarProcessMonth() {
		return declarProcessMonth;
	}
	public void setDeclarProcessMonth(String declarProcessMonth) {
		this.declarProcessMonth = declarProcessMonth;
	}
	...
	public BigDecimal getTotalTaxToBePaid() {
		return totalTaxToBePaid;
	}
	public void setTotalTaxToBePaid(BigDecimal totalTaxToBePaid) {
		this.totalTaxToBePaid = totalTaxToBePaid;
	}
}
