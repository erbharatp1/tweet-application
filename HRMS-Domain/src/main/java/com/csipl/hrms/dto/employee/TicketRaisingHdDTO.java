...
public class TicketRaisingHdDTO {
	...
	public String toString() {
		return "TicketRaisingHdDTO [ticketRaisingHDId=" + ticketRaisingHDId + ", title=" + title + ", createdBy="
				+ createdBy + ", userId=" + userId + ", dateCreated=" + dateCreated + ", ticketTypeId=" + ticketTypeId
				+ ", category=" + category + ", description=" + description + ", comment=" + comment + ", status="
				+ status + ", ticketNo=" + ticketNo + ", ticketDescs=" + ticketDescs + ", employeeId=" + employeeId
				+ ", employeeCode=" + employeeCode + ", employeeName=" + employeeName + ", user=" + user + ", tat="
				+ tat + ", companyId=" + companyId + ", userIdUpdate=" + userIdUpdate + ", emailId=" + emailId + "]";
	}
