...
public class CandidateDTO {
	...
	private String loginActiveDeactiveStatus;
	
	public String getLoginActiveDeactiveStatus() {
		return loginActiveDeactiveStatus;
	}

	public void setLoginActiveDeactiveStatus(String loginActiveDeactiveStatus) {
		this.loginActiveDeactiveStatus = loginActiveDeactiveStatus;
	}
