...
public class WeekOffPatternDTO {
	...
	private  List<WeekOffPatternDTO> weekOffDto = new ArrayList<WeekOffPatternDTO>();
	...
	public List<WeekOffPatternDTO> getWeekOffDto() {
		return weekOffDto;
	}

	public void setWeekOffDto(List<WeekOffPatternDTO> weekOffDto) {
