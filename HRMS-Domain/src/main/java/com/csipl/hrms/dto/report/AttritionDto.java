...
//	List<HashMap<String,ArrayList<Category>>> categories = new ArrayList<HashMap<String,ArrayList<Category>>>();
	...
	public String getAttritionYear() {
		return attritionYear;
	}
	public void setAttritionYear(String attritionYear) {
		this.attritionYear = attritionYear;
	}
