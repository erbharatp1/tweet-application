...
public class EpfDTO {
	...
	public EpfDTO(Long epfId, BigDecimal employeePer, BigDecimal employerPer, BigDecimal employerPensionPer,
			BigDecimal adminPer, BigDecimal edliPer, BigDecimal edliExpPer, BigDecimal maxBasicLimit,
			Date effectiveDate, String activeStatus, Long userId, Date dateCreated, BigDecimal maxPensionLimit,
			String isActual, Long companyId, Long userIdUpdate) {
		this.epfId = epfId;
	...
	public String toString() {
		return "EpfDTO [epfId=" + epfId + ", employeePer=" + employeePer + ", employerPer=" + employerPer
				+ ", employerPensionPer=" + employerPensionPer + ", adminPer=" + adminPer + ", edliPer=" + edliPer
				+ ", edliExpPer=" + edliExpPer + ", maxBasicLimit=" + maxBasicLimit + ", effectiveDate=" + effectiveDate
				+ ", activeStatus=" + activeStatus + ", userId=" + userId + ", dateCreated=" + dateCreated
				+ ", maxPensionLimit=" + maxPensionLimit + ", isActual=" + isActual + ", companyId=" + companyId
