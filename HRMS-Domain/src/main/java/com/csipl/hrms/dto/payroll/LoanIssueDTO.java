...
public class LoanIssueDTO {
	...
	private Long userId;
	private String deductionFromPayroll;
	...
	public BigDecimal getTotalEmiAmount() {
		return totalEmiAmount;
	}

	public void setTotalEmiAmount(BigDecimal totalEmiAmount) {
	...
	public String getDeductionFromPayroll() {
		return deductionFromPayroll;
	}

	public void setDeductionFromPayroll(String deductionFromPayroll) {
		this.deductionFromPayroll = deductionFromPayroll;
	}
	...
	public void setActualEmi(Long actualEmi) {
	...
	public Date getLoanReleasedOn() {
		return loanReleasedOn;
	}

	public void setLoanReleasedOn(Date loanReleasedOn) {
		this.loanReleasedOn = loanReleasedOn;
	}

	public BigDecimal getLoanRecovered() {
		return loanRecovered;
	}

	public void setLoanRecovered(BigDecimal loanRecovered) {
	...
	// return "LoanIssueDTO [transactionNo=" + transactionNo + ", employeeId=" +
	// employeeId + ", loanAmount="
	// + loanAmount + ", issueDate=" + issueDate + ", noOfEmi=" + noOfEmi + ",
	// rateOfInterest="
	// + rateOfInterest + ", naration=" + naration + ", loanType=" + loanType + ",
	// loanTypeLabel="
	// + loanTypeLabel + ", interestType=" + interestType + ", emiAmount=" +
	// emiAmount + ", emiStartDate="
	// + emiStartDate + ", transactionDate=" + transactionDate + ", dateOfJoining="
	// + dateOfJoining
	// + ", employeeCode=" + employeeCode + ", departmentName=" + departmentName +
	// ", designationName="
	// + designationName + ", employeeName=" + employeeName + ", flag=" + flag + ",
	// userId=" + userId
	// + ", dateCreated=" + dateCreated + ", activeStatus=" + activeStatus + ",
	// loanPendingAmount="
	// + loanPendingAmount + ", activeStatusLabel=" + activeStatusLabel + ",
	// settlementAmount="
	// + settlementAmount + ", paymentMode=" + paymentMode + ", instrumentNo=" +
	// instrumentNo + ", remark="
	// + remark + ", isSettlementCompleted=" + isSettlementCompleted + ",
	// loanEmisDto=" + loanEmisDto + "]";
	// }
