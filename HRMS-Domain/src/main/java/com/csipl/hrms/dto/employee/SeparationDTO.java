...
public class SeparationDTO {
	...
	private int seprationMyTeamCount;
	private int seprationMyCount;
	...
	/**
	 * @return the seprationMyTeamCount
	 */
	public int getSeprationMyTeamCount() {
		return seprationMyTeamCount;
	}

	/**
	 * @param seprationMyTeamCount
	 *            the seprationMyTeamCount to set
	 */
	public void setSeprationMyTeamCount(int seprationMyTeamCount) {
		this.seprationMyTeamCount = seprationMyTeamCount;
	}

	public int getSeprationMyCount() {
		return seprationMyCount;
	}

	public void setSeprationMyCount(int seprationMyCount) {
		this.seprationMyCount = seprationMyCount;
	}
