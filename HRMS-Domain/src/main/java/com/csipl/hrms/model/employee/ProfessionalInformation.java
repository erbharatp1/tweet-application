...
public class ProfessionalInformation extends BaseModelWithoutCG implements Serializable {
	...
	public String toString() {
		return "ProfessionalInformation [historyId=" + historyId + ", allowModi=" + allowModi + ", annualSalary="
				+ annualSalary + ", dateFrom=" + dateFrom + ", dateTo=" + dateTo + ", designation=" + designation
				+ ", organizationName=" + organizationName + ", reasonForChange=" + reasonForChange
				+ ", reportingContact=" + reportingContact + ", reportingTo=" + reportingTo + ", employeeId="
				+ employeeId + ", professionalDoc=" + professionalDoc + ", docIndex=" + docIndex + ", documentName="
				+ documentName + ", empCode=" + empCode + "]";
	}
