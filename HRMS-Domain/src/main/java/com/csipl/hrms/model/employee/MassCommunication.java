...
//	private List<CompanyAnnouncement> companyAnnouncement;
	@OneToMany( cascade =CascadeType.ALL,mappedBy = "massCommunication" )
	private List<CompanyAnnouncement> companyAnnouncements;

	public List<CompanyAnnouncement> getCompanyAnnouncements() {
		return companyAnnouncements;
	}

	public void setCompanyAnnouncements(List<CompanyAnnouncement> companyAnnouncements) {
