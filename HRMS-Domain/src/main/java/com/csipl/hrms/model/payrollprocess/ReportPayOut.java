...
public class ReportPayOut implements Serializable {
	...
	@Column(name="stdEpfWagesAmount")
	private BigDecimal stdEpfWagesAmount;
	
	@Column(name="EarnedStdEpfWagesAmount")
	private BigDecimal EarnedStdEpfWagesAmount;
...
//	private String processMonth;
	...
	private String isEpfOnActualAmount;
	public ReportPayOut() {
	}
	...
	public BigDecimal getStdEpfWagesAmount() {
		return stdEpfWagesAmount;
	}

	public void setStdEpfWagesAmount(BigDecimal stdEpfWagesAmount) {
		this.stdEpfWagesAmount = stdEpfWagesAmount;
	}

	public BigDecimal getEarnedStdEpfWagesAmount() {
		return EarnedStdEpfWagesAmount;
	}

	public void setEarnedStdEpfWagesAmount(BigDecimal earnedStdEpfWagesAmount) {
		EarnedStdEpfWagesAmount = earnedStdEpfWagesAmount;
	}
	...
	public String getIsEpfOnActualAmount() {
		return isEpfOnActualAmount;
	}

	public void setIsEpfOnActualAmount(String isEpfOnActualAmount) {
		this.isEpfOnActualAmount = isEpfOnActualAmount;
	}
