...
/*	public TdsApproved addTdsApproved(TdsApproved tdsApproved) {
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", activeStatus=" + activeStatus + ", allowModi=" + allowModi
				+ ", anniversaryDate=" + anniversaryDate + ", bloodGroup=" + bloodGroup + ", contractStartDate="
				+ contractStartDate + ", contractOverDate=" + contractOverDate + ", dateCreated=" + dateCreated+", companyId="+ companyId
				+ ", dateOfBirth=" + dateOfBirth + ", endDate=" + endDate + ", dateOfJoining=" + dateOfJoining+ ",roleId="+ roleId
				+ ", dateUpdate=" + dateUpdate + ", effectiveDate=" + effectiveDate + ", employeeCode=" + employeeCode
				+ ", empType=" + empType + ", firstName=" + firstName + ", gender=" + gender + ", employeeLogoPath="
				+ employeeLogoPath + ", lastName=" + lastName + ", adharNumber=" + adharNumber + ", maritalStatus="
				+ maritalStatus + ", middleName=" + middleName + ", noticePeriodDays=" + noticePeriodDays
				+ ", probationDays=" + probationDays + ", referenceName=" + referenceName + ", gradesId=" + gradesId
				+ ", voluntaryPfContribution=" + voluntaryPfContribution + ", alternateNumber=" + alternateNumber
				+ ", timeContract=" + timeContract + ", contactNo=" + contactNo + ", officialEmail=" + officialEmail
				+ ", personalEmail=" + personalEmail + ", reportingToEmployee=" + reportingToEmployee + ", shiftId="
				+ shiftId + ", patternId=" + patternId + ", address1=" + address1 + ", address2=" + address2
				+ ", address3=" + address3 + ", employeeLanguages=" + employeeLanguages + ", department=" + department
				+ ", designation=" + designation + ", project=" + project + ", client=" + client + ", state=" + state
				+ ", city=" + city + ", employeeSkills=" + employeeSkills + ", payStructureHds=" + payStructureHds
				+ ", employeeBanks=" + employeeBanks + ", employeeIdProofs=" + employeeIdProofs
				+ ", employeeStatuaries=" + employeeStatuaries + ", tdsTransactions=" + tdsTransactions
				+ ", mandatoryInfoChecks=" + mandatoryInfoChecks + ", newSkillValues=" + newSkillValues
				+ ", genderValue=" + genderValue + ", bankNameValue=" + bankNameValue + ", accountTypeValue="
				+ accountTypeValue + ", maritalStatusValue=" + maritalStatusValue + ", empTypeValue=" + empTypeValue
