...
public class EmployeeFamily implements Serializable {
	...
	public String toString() {
		return "EmployeeFamily [familyId=" + familyId + ", allowModi=" + allowModi + ", captions=" + captions
				+ ", contactMobile=" + contactMobile + ", contactPhone=" + contactPhone + ", dateCreated=" + dateCreated
				+ ", dateOfBirth=" + dateOfBirth + ", dateUpdate=" + dateUpdate + ", name=" + name + ", occupations="
				+ occupations + ", qualificationId=" + qualificationId + ", relation=" + relation + ", userId=" + userId
				+ ", userIdUpdate=" + userIdUpdate + ", employee=" + employee + ", employeeNominees=" + employeeNominees
				+ ", employeeStatuaries=" + employeeStatuaries + "]";
	}
	...
	public EmployeeStatuary addEmployeeStatuary(EmployeeStatuary employeeStatuary) {
		...
		employeeStatuary.setEmployeeFamily(this);
	...
	public EmployeeStatuary removeEmployeeStatuary(EmployeeStatuary employeeStatuary) {
		...
		employeeStatuary.setEmployeeFamily(null);
