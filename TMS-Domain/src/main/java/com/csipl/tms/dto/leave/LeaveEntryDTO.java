...
public class LeaveEntryDTO {
	...
	@ApiModelProperty(notes = "Leave Type MasterID")
	...
	private List<EmployeeDTO> notifyEmployeeList = new ArrayList<EmployeeDTO>();
	...
	public int getLeaveCountMyTeam() {
		return leaveCountMyTeam;
	}
	...
	public void setLeaveCountMyTeam(int leaveCountMyTeam) {
		this.leaveCountMyTeam = leaveCountMyTeam;
	}
