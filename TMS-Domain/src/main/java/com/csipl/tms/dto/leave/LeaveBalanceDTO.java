...
public class LeaveBalanceDTO {
	...
	List<TMSWeekOffChildPatternDTO> tmsWeekOffChildPatternDTO;
	...
	public List<TMSWeekOffChildPatternDTO> getTmsWeekOffChildPatternDTO() {
		return tmsWeekOffChildPatternDTO;
	}

	public void setTmsWeekOffChildPatternDTO(List<TMSWeekOffChildPatternDTO> tmsWeekOffChildPatternDTO) {
		this.tmsWeekOffChildPatternDTO = tmsWeekOffChildPatternDTO;
	}
