...
public class LeaveBalanceSummryDTO {
	...
	private BigDecimal carryForwordLeave;
    ...
    private List<Date> appliedSandwhichDates;
    ...
    private BigDecimal encashableAmount;
	
	public BigDecimal getEncashableAmount() {
		return encashableAmount;
	}

	public void setEncashableAmount(BigDecimal encashableAmount) {
		this.encashableAmount = encashableAmount;
	}
	...
	public BigDecimal getCarryForwordLeave() {
		return carryForwordLeave;
	}

	public void setCarryForwordLeave(BigDecimal carryForwordLeave) {
