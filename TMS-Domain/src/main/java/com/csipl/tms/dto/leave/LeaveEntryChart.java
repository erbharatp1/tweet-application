...
public class LeaveEntryChart {
	...
	String chartLeftMargin, chartRightMargin, defaultCenterLabel, centerLabelColor, doughnutRadius;
	String canvasbgColor;

	public LeaveEntryChart(String showBorder, String use3dLighting, String enableSmartLabels, String startingAngle,
		...
		this.defaultCenterLabel = centerlabel;
