...
public class AttendanceRegularizationRequestDTO {
	...
	/**
	 * @param employeeLogoPath the employeeLogoPath to set
	 */
	public void setEmployeeLogoPath(String employeeLogoPath) {
		this.employeeLogoPath = employeeLogoPath;
	}

	public int getMyTeamARCount() {
		return myTeamARCount;
	}

	public void setMyTeamARCount(int myTeamARCount) {
		this.myTeamARCount = myTeamARCount;
	}
