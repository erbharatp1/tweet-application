...
/**
 * The persistent class for the TMSLeaveType database table.
 * 
 */
@Entity
...
public class TMSLeaveType implements Serializable {
	...
	// @OneToMany(fetch = FetchType.LAZY,mappedBy="tmsleaveType" , cascade =
	// CascadeType.REMOVE)
	...
	@Column(name = "leaveProbationCalculatedOn")
	private String leaveCalculatedOn;
	...
	/*
	 * public List<TMSLeaveEntry> getTmsleaveEntries() { return
	 * this.tmsleaveEntries; }
	 * 
	 ...
	 * getTmsleaveEntries().add(tmsleaveEntry); tmsleaveEntry.setTmsleaveType(this);
	 * 
	...
	public String getLeaveCalculatedOn() {
		return leaveCalculatedOn;
	}

	public void setLeaveCalculatedOn(String leaveCalculatedOn) {
		this.leaveCalculatedOn = leaveCalculatedOn;
	}
