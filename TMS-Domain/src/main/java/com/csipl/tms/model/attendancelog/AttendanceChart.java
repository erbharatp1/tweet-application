...
public class AttendanceChart {
	...
	public AttendanceChart(String formatnumberscale, String use3dLighting, String enableSmartLabels,
			String startingAngle, String showLabels, String showPercentValues, String showLegend,
			String centerLabelBold, String showTooltip, String decimals, String useDataPlotColorForLabels,
			String theme) {
		super();
